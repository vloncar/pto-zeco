...
class TestMatmul(SceneTestCase):
    ...
    CASES = [
        {"name": "NN", "platforms": ["a2a3"],
         "config": {"aicpu_thread_num": 4, "block_dim": 24}, "params": {"mode": 0}},
        {"name": "TN", "platforms": ["a2a3"],
         "config": {"aicpu_thread_num": 4, "block_dim": 24}, "params": {"mode": 1}},
        {"name": "NT", "platforms": ["a2a3"],
         "config": {"aicpu_thread_num": 4, "block_dim": 24}, "params": {"mode": 2}},
    ]
    ...
    def generate_args(self, params):
        ...
        config = torch.tensor([params["mode"]], dtype=torch.int64)
